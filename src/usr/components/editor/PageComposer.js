...
class PageComposer extends React.Component {
  ...
  static defaultProps = {
    ...
    onGenerateCode: () => {
      console.info('PageComposer.onGenerateCode is not set');
    },
  };
        ...
        <div className={classes.topPane}>
          <CommonToolbar disableGutters={true} dense="true">
            <ToolbarButton
              ...
              iconColor="#4caf50"
              title="Generate Code"
              tooltip="Generate the source code of the new React component"
                  ...
                  <div className={classes.root}>
                    {appUrl && (
                      <IFrame
                        ...
                        url={isPreviewMode
                          ? `${appUrl}/webcodesk__component_view`
                          : `${appUrl}/webcodesk__page_composer?iframeId=${this.iframeId}`
                        }
                        offPointers={showIframeDropPanelCover}
