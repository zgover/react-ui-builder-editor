...
class RenamePageDialog extends React.Component {
  static propTypes = {
  ...
  static defaultProps = {
    ...
    pageResource: null,
    onClose: () => {
      console.info('RenamePageDialog.onClose is not set');
    },
    onSubmit: (options) => {
      console.info('RenamePageDialog.onSubmit is not set: ', options);
    },
  };
    ...
    return (
      ...
      >
        <form onSubmit={this.handleSubmit}>
          ...
          >
            {pageResource ? `Rename "${pageResource.displayName}" Page` : 'Rename Page'}
          </DialogTitle>
          <DialogContent>
            <TextField
              autoFocus={true}
