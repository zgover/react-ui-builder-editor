...
export default [
  {
    type: 'component',
    props: {
      componentName: 'usr.components.dialogs.RenameFlowDialog.RenameFlowDialog',
      componentInstance: 'renameFlowDialog1',
    },
    events: [
      {
        name: 'onSubmit',
        targets: [
          {
            type: 'userFunction',
            props: {
              functionName: 'usr.api.resourcesTreeViewMethods.renameFlowSubmit',
            },
            events: [
              {
                name: 'isDialogOpen',
